...
function ContactForm() {
    ...
    const [footerVisible, setFooterVisible] = useState(true); // Manage footer visibility

    // Variable for setting the minimum date to today
    ...
    const handleSubmit = (event) => {
        ...
        if (form.checkValidity() === false) {
            ...
            setFooterVisible(false); // Hide footer using state
            const contactPage = document.getElementById('contact-page');
            if (contactPage) {
                contactPage.classList.add('scrolling-stop');
            }
        }
    ...
    return (
        ...
        >
                ...
                <Form.Group className="row mb-3">
                    <Col className="mb-3 mb-md-0" md={6}>
                        ...
                        <Form.Control
                            ...
                            required
                            min={minDate}  // Make sure the date is not before today
                        />
                        <ValidFeedback />
            ...
            {/* Render footer only if it's visible */}
            {footerVisible && <div id="footer">Your footer content here</div>}
        </motion.div>
    );
}
