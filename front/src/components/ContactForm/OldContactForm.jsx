                    ...
                    <div class="modal-dialog d-flex align-items-center">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <p>Cher(e) ${this.state.firstName} ${this.state.lastName}, <br>
                                Merci pour votre réservation pour ${this.state.numberOfGuests} personnes le ${this.state.date} ! <br>
                                Vous recevrez une confirmation sur votre adresse email ${this.state.email} <br>
                                et en cas de problème, nous vous contacterons sur votre numéro de téléphone ${this.state.phoneNumber}.</p>
                            </div>
                            <div class="modal-footer">
                                <button type="button" class="btn btn-success btn-lg" data-bs-dismiss="modal" onClick="window.location.reload()">Fermer</button>
                            </div>
                        </div>
                    </div>
                </div>
