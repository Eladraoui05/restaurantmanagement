                    ...
                    <div class="modal-dialog d-flex align-items-center">
                        <div class="modal-content rounded-0">
                            ...
                            <div class="modal-body">
                                ...
                                <p>Merci pour votre réservation de ${numberOfGuests} personnes pour le ${date}. Vous recevrez bientôt un e-mail de confirmation à l'adresse ${emailAddress}.</p>
                                <p>À bientôt !</p>
                            </div>
                            <div class="modal-footer">
                                <button type="button" class="btn btn-success btn-lg rounded-0" data-bs-dismiss="modal" onClick="window.location.reload()">Fermer</button>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <Form noValidate validated={validated} className="bg-dark text-light p-5 needs-validation" id="form" onSubmit={handleSubmit}>
                <Form.Group className="row mb-3">
                    <Col className="mb-3 mb-md-0" md={6}>
                        <Form.Label htmlFor="first-name" className="text-capitalize">Prénom</Form.Label>
                        ...
                        <ValidFeedback />
                        <InvalidFeedback message='Veuillez entrer votre prénom.' />
                    </Col>
                    <Col md={6}>
                        <Form.Label htmlFor="last-name" className="text-capitalize">Nom de famille</Form.Label>
                        ...
                        <ValidFeedback />
                        <InvalidFeedback message='Veuillez entrer votre nom de famille.' />
                    </Col>
                </Form.Group>

                <Form.Group className="row mb-3">
                    <Col className="mb-3 mb-md-0" md={6}>
                        <Form.Label htmlFor="phone-number" className="text-capitalize">Numéro de téléphone</Form.Label>
                        ...
                        <ValidFeedback />
                        <InvalidFeedback message='Veuillez entrer votre numéro de téléphone.' />
                    </Col>
                    <Col md={6}>
                        <Form.Label htmlFor="email" className="text-capitalize">Adresse e-mail</Form.Label>
                        ...
                        <ValidFeedback />
                        <InvalidFeedback message='Veuillez entrer votre adresse e-mail.' />
                    </Col>
                </Form.Group>
                ...
                <Form.Group className="row mb-3">
                    <Col className="mb-3 mb-md-0" md={6}>
                        ...
                        <ValidFeedback />
                        <InvalidFeedback message='Veuillez choisir une date.' />
                    </Col>
                    <Col md={6}>
                        <Form.Label htmlFor="guests" className="text-capitalize">Nombre d'invités</Form.Label>
                        ...
                        <ValidFeedback />
                        <InvalidFeedback message="Veuillez choisir le nombre d'invités." />
                    </Col>
                </Form.Group>

                <Form.Group className="mb-3">
                    <Form.Label htmlFor="comments">Commentaires</Form.Label>
